    ...
    <div class="col-12">
      <div class="email-label">
        <router-link
          ...
          class="mail-label badge rounded-pill badge-light-primary"
          >Edit
        </router-link>
      </div>
    </div>
        ...
        <div class="card">
                ...
                <div class="email-info-dropup dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="card_top01">
                    <table class="table table-sm table-hover">
                      <tbody>
                        <tr
                          v-for="(signer, index) in props.document.participants"
                          :key="index"
                        >
                          <td>{{ ++index }}.</td>
          ...
          <div class="card-body mail-message-wrapper pt-2">
            <div class="mail-message">
              <div
                v-for="(doc, index) in props.document.documentUploads"
                class="border mb-1"
                :key="index"
              >
                ...
                <div class="clearfix">
                  <h6 class="float-end">
                    Page {{ ++index }} of
                    {{ props.document.documentUploads.length }}
                  </h6>
                </div>
              </div>
            </div>
