<template>
  <div class="tool">
    <li class="btn" :class="{ blue: tool.hasPresence }" :data-user="tool.userId" :data-email="tool.userEmail"
      data-value="Textarea" @click="
        isSignerSelected({
          toolId: 'textTool',
          tool_name: 'Textarea',
          user_id: tool.userId,
...
const tool = ref({});
watch(() => props.tools, (toolObj) => tool.value = toolObj);
